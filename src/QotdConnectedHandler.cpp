 ...
 * established events for a Quote of the Day (QOTD) client. When a connection is established,
...
namespace e5 {
     ...
     * 2. Disables Nagle's algorithm by setting no delay to true for lower latency
